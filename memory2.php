...
<div class="w3-top">
  <div class="w3-row w3-padding w3-black">
    <div class="w3-col s3">
      <a href="emotional2.php" class="w3-button w3-block w3-black"><h6><i class="fa fa-heartbeat"></i> Emotions</h6></a>
    </div>
    <div class="w3-col s3">
      <a href="phobic2.php" class="w3-button w3-block w3-black"><h6><i class="fa fa-snowflake-o"></i> Phobic</h6></a>
    </div>
    <div class="w3-col s3">
      <a href="dream2.php" class="w3-button w3-block w3-black"><h6><i class="fa fa-heart-o"></i> Dream</h6></a>
    </div>
    <div class="w3-col s3">
      <a href="memory2.php" class="w3-button w3-block w3-black"><h6><i class="fa fa-connectdevelop"></i> Memory</h6></a>
    </div>
</div>
...
<div class="w3-top w3-hide-large w3-hide-medium" id="myNavbar">
  <div class="w3-bar w3-black w3-opacity w3-hover-opacity-off w3-center w3-small">
    <a href="emotional2.php" class="w3-bar-item w3-button" style="width:25% !important"><h6 style="color:white">Emotions</h6></a>
    <a href="phobic2.php" class="w3-bar-item w3-button" style="width:25% !important"><h6>Phobic</h6></a>
    <a href="dream2.php" class="w3-bar-item w3-button" style="width:25% !important"><h6>Dream</h6></a>
    <a href="memory2.php" class="w3-bar-item w3-button" style="width:25% !important"><h6>Memory</h6></a>
  </div>
</div>
...
if(isset($_POST['submit']))
{
 ...
 ?>
  ...
  <!-- End Contact Section -->
    ...
    <a href="user.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-left w3-margin-right"></i>Back</a>
