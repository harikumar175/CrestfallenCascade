...
<div class="w3-top">
  <div class="w3-row w3-padding w3-black">
    ...
    <div class="w3-col s3">
      <a href="#poem" class="w3-button w3-block w3-black">POEMS</a>
    </div>
    <div class="w3-col s3">
      <a href="#home" class="w3-button w3-block w3-black">QUOTES</a>
    </div>
    <div class="w3-col s3">
  <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-block w3-black">SIGNIN</button>
  ...
  <div id="id01" class="w3-modal w3-animate-opacity">
    <div class="w3-modal-content w3-card-4">
      <header class="w3-container w3-black">
        ...
        <h2><i class="fa fa-user"></i>&nbsp;User Signin</h2>
      </header>
      <div class="w3-container w3-black">
        ...
        </form><a href="newuser.php"><button class="w3-button w3-black w3-left w3-section" type="submit">
...
<div class="w3-padding-large" id="main">
  ...
  <header class="w3-container w3-padding-32 w3-center w3-black" >
    ...
    <p>"R<span style="color:red">evol</span>ution is <span style="color:red">Love</span>"</p>
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    ...
    <p class="w3-text-white"> <span style="color:red">MEMORIES</span> probably the hardest thing to get over. For you too probably .most people start writing coz of that. And I am no exception. And writing does help you to bring your soul out. Probably it’s the best way you could. Maybe talking wouldn’t help you but a pen and paper would do much a great job. And write to feed your thoughts and soul and not others. So yah this is a place none judge and you can pour out your heart. Well poems had been a tool to vent out the chains holding me from the past. There are people around you constantly teaching you what life is either by standing by you or turning against you.That’s how it works, no change. But you can bring a change to your within by penning your feelings. Than spoken words, written words has its own charm and spell.Lets put out our writeups to bring out the charm. Let the poems do the rest of talking!! 
    </p>
  </div>
    <style>
...
<div class="w3-content w3-justify w3-text-grey w3-padding-64" id="home">
  <h2 class="w3-text-light-grey" >Quotes</h2>
  <hr style="width:200px" class="w3-opacity">
...
<div class="mySlides">
  <h4><q style="color:white";>I love the more in that I believe you had liked me and for nothing else</q></h4>
  <p style="color:white";>- Sarah</p>
</div>

<div class="mySlides">
  <h4><q style="color:white";>Love is the cause of extreme happiness and even the extreme pain.</q></h4>
  <p style="color:white";>- Sarah</p>
</div>
...
<hr class="w3-opacity">
  ...
  <center>  <button onclick="document.getElementById('id02').style.display='block'" class="w3-button w3-black w3-middle"><h5><u>Create a Quote</u></h5></button></center>
  <div id="id02" class="w3-modal w3-animate-opacity">
    <div class="w3-modal-content w3-card-4">
      <header class="w3-container w3-black">
        <span onclick="document.getElementById('id02').style.display='none'"
        class="w3-button w3-large w3-display-topright">&times;</span>
        <h2><i class="fa fa-user"></i>&nbsp; Signin to Post Quotes</h2>
      </header>
      <div class="w3-container w3-black">
        ...
        <form action="login2.inc.php" target="" method="POST">
          ...
          <div class="w3-full">
            <input class="w3-input w3-border w3-black" type="text" placeholder="Username" required name="username">
          </div><br>

          <h6 class="w3-text-light-grey">Password</h6>

          <div class="w3-full">
            <input class="w3-input w3-border w3-black" type="password" placeholder="Password" required name="password">
          </div>
          <footer class="w3-container w3-black">
            <button class="w3-button w3-black w3-left w3-section " type="submit" name="submit">
              <i class="fa fa-paper-plane"></i> Signin
...
<hr class="w3-opacity">
<div class="w3-container w3-middle">
<center>  <button onclick="document.getElementById('id03').style.display='block'" class="w3-button w3-black w3-middle"><h4><u>Post a Poem</u></h4></button></center>
<div id="id03" class="w3-modal w3-animate-opacity">
  <div class="w3-modal-content w3-card-4">
    <header class="w3-container w3-black">
      <span onclick="document.getElementById('id03').style.display='none'"
      class="w3-button w3-large w3-display-topright">&times;</span>
      <h2><i class="fa fa-user"></i>&nbsp; Signin to Post a Poem</h2>
    </header>
    <div class="w3-container w3-black">
...
<center> <a href="emotional1.php"><button  class="w3-button w3-black w3-middle"><h5><u>Collections of Poem</u></h5></button></a></center>
    <!-- End photo grid -->
    </div>
  ...
  <div class="w3-row w3-padding-32 w3-section">
    <div class="w3-col m4 w3-container">
      <a href="adminsignin.php"><img src="title3.jpg" class="w3-image w3-round" style="width:100%"></a>
    </div>
 ...
 ?>
  ...
  <!-- End Contact Section -->
    ...
    <div class="w3-xlarge w3-section">
      <a href="https://www.facebook.com/crestfallen.cascade"><i class="fa fa-facebook-official w3-hover w3-hover-text-blue"></i></a>
      <a href="https://www.instagram.com/crestfallencascade/"><i class="fa fa-instagram w3-hover w3-hover-text-pink"></i></a>
