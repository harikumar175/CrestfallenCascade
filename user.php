...
<div class="w3-top">
  ...
  <div id="id01" class="w3-modal w3-animate-opacity">
    <div class="w3-modal-content w3-card-4">
      ...
      <a href="user.php">  <button class="w3-button w3-black w3-left w3-section" type="submit">
           No
        </button></a><br>
      </footer>
    </div>
...
<hr class="w3-opacity">
<a href="emotional2.php"><center><button class="w3-button w3-black w3-middle"><h3 style=font-family:"Parisienne"><u>More Collections of Poems</u></h3></button></center></a>
